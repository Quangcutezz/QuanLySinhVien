...
import com.example.quanlysinhvien.databinding.ActivityEmployeeBinding;
...
public class EmployeeActivity extends AppCompatActivity {
    ...
    private ActivityEmployeeBinding binding2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding2 = ActivityEmployeeBinding.inflate(getLayoutInflater());
        setContentView(binding2.getRoot());
        DrawerLayout drawer = binding2.drawerLayout2;
        setSupportActionBar(binding2.appBarTemplateEmployee.toolbar2);
        initUI();

        NavigationView navigationView = binding2.navView2;
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_template_employee);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.template_employee_activity, menu);
        return true;
    }
    ...
    private void initUI(){
        mNavigationView = binding2.navView2;
